...
with base.p.get_chain('horton') as chain:
    transaction={'from': OWNER}
    # donator, deploy_tx_hash = chain.provider.get_or_deploy_contract('Donator', transaction={'from': OWNER})

    donator, deploy_tx_hash = chain.provider.get_or_deploy_contract(
    	'Donator', 
